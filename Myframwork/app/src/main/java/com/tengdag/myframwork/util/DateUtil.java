...
public class DateUtil {
	...
	public static final String FORMAT_YEAR_SECOND2 = "yyyy/MM/dd HH:mm:ss";
	public static final String FORMAT_YEAR_SECOND_WEEK = "yyyy-MM-dd HH:mm:ss EEE";
	public static final String FORMAT_YEAR_SECOND_WEEK2 = "yyyy/MM/dd HH:mm:ss EEE";
	public static final String FORMAT_YEAR_MILLISECOND = "yyyy-MM-dd HH:mm:ss SSS";

	public final static String FPRMAT_ONLY_MONTH_DATE = "MM-dd";
	public final static String FPRMAT_ONLY_HOUR_MINUTE = "HH:mm";
	public final static String FPRMAT_YEAR_DATE = "yyyy-MM-dd";
	public final static String FPRMAT_YEAR_MIUNTE = "yyyy-MM-dd HH:mm";
	...
	public static String formatOnlyMonthDate(long time) {
		return format(FPRMAT_ONLY_MONTH_DATE, time);
	}
	
	public static String formatOnlyHourMinute(long time) {
	    return format(FPRMAT_ONLY_HOUR_MINUTE, time);
	}
	
	public static String formatDate(long time) {
	    return format(FPRMAT_YEAR_DATE, time);
	}
	
	public static String formatMinute(long time) {
	    return format(FPRMAT_YEAR_MIUNTE, time);
	}
	
	public static String formatChineseYesterday(long time) {
		return "昨天" + formatOnlyHourMinute(time);
	}
	...
	public static String formatChineseOnlyMonthDate(long time) {
		Calendar calendar = getCalendar(time);
		return String.format("%d月%d日", getMonth(calendar), getDate(calendar));
	}
	
	public static String formatChineseOnlyHourMinute(long time) {
		Calendar calendar = getCalendar(time);
		return String.format("%d点%d分", getHour(calendar), getMinute(calendar));
	}
	...
	public static boolean isYesterday(long nowTime, long time) {
		return isSameDate(nowTime, time + 86400000);
	}
